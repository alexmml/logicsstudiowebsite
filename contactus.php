...
<body ng-app="myapp">
    ...
    <div id="content" class="content">
        <div class="subcontent-2-con" id="page0_con">
            <div class="pagewidth">
                <div class="title_con">
                    <h1>Contact Us</h1>
                    <h2>Get in touch</h2>
                ...
                <br />
                <br />
                <h3>The <b>Basics</b></h3>
                <h4>Just add some info to know you</h4>
                <ul class="flex-6">
                    <li>
                        <div>
                    ...
                    <li>
                        <div>
                            <label for="">Company <i>(optional)</i></label>
                            <input type="text" />
                        </div>
                    </li>
                    <li>
                        <div>
                            <label for="">Website <i>(optional)</i></label>
                            <input type="url" />
                        </div>
                    </li>
                    <li>
                        <div>
                            <label for="">Skype <i>(optional)</i></label>
                            <input type="text" />
                        </div>
                    </li>
                </ul>
                <br />
                <h3>The <b>Details</b></h3>
                <h4>Just add some aditional info to know what we will talk about and let us make a plan before contact</h4>
                <ul class="flex-6">
                    <li style="flex: 0 100%;">
                        <div>
                            <label for="">Summary <i>(optional)</i></label>
                            <textarea></textarea>
                        </div>
                    </li>
                    <li style="flex: 0 100%;">
